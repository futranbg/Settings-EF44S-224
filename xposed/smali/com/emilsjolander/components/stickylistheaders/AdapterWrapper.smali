...
.method static synthetic access$1(Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;)Ljava/util/List;
    .locals 1
    .parameter
...
.method static synthetic access$2(Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;)V
    .locals 0
    .parameter
...
.method static synthetic access$3(Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;)V
    .locals 0
    .parameter
...
.method static synthetic access$4(Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;)Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper$OnHeaderClickListener;
    .locals 1
    .parameter
...
.method private configureHeader(Lcom/emilsjolander/components/stickylistheaders/WrapperView;I)Landroid/view/View;
    ...
    .prologue
    .line 128
    iget-object v1, p1, Lcom/emilsjolander/components/stickylistheaders/WrapperView;->mHeader:Landroid/view/View;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Lcom/emilsjolander/components/stickylistheaders/WrapperView;
    ...
    iget-object v3, p0, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lcom/emilsjolander/components/stickylistheaders/WrapperView;-><init>(Landroid/content/Context;)V

    .line 165
    .end local p2
    .local v2, wv:Lcom/emilsjolander/components/stickylistheaders/WrapperView;
    :goto_0
    iget-object v3, p0, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->mDelegate:Lcom/emilsjolander/components/stickylistheaders/StickyListHeadersAdapter;

    iget-object v4, v2, Lcom/emilsjolander/components/stickylistheaders/WrapperView;->mItem:Landroid/view/View;

    invoke-interface {v3, p1, v4, v2}, Lcom/emilsjolander/components/stickylistheaders/StickyListHeadersAdapter;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 168
    invoke-direct {p0, v2}, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->recycleHeaderIfExists(Lcom/emilsjolander/components/stickylistheaders/WrapperView;)V
    ...
    instance-of v3, v2, Lcom/emilsjolander/components/stickylistheaders/CheckableWrapperView;

    if-nez v3, :cond_3

    .line 174
    new-instance v2, Lcom/emilsjolander/components/stickylistheaders/CheckableWrapperView;

    .end local v2           #wv:Lcom/emilsjolander/components/stickylistheaders/WrapperView;
    iget-object v3, p0, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lcom/emilsjolander/components/stickylistheaders/CheckableWrapperView;-><init>(Landroid/content/Context;)V

    .line 178
    .restart local v2       #wv:Lcom/emilsjolander/components/stickylistheaders/WrapperView;
    :cond_0
    :goto_2
    iget-object v3, p0, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->mDivider:Landroid/graphics/drawable/Drawable;

    iget v4, p0, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->mDividerHeight:I

    invoke-virtual {v2, v1, v0, v3, v4}, Lcom/emilsjolander/components/stickylistheaders/WrapperView;->update(Landroid/view/View;Landroid/view/View;Landroid/graphics/drawable/Drawable;I)V
    ...
    .restart local v2       #wv:Lcom/emilsjolander/components/stickylistheaders/WrapperView;
    :cond_2
    invoke-direct {p0, v2, p1}, Lcom/emilsjolander/components/stickylistheaders/AdapterWrapper;->configureHeader(Lcom/emilsjolander/components/stickylistheaders/WrapperView;I)Landroid/view/View;
