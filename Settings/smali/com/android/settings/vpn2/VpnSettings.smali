...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {v5}, Lcom/android/settings/vpn2/VpnDialog;->getProfile()Lcom/android/settings/vpn2/VpnProfile;

    move-result-object v4

    .line 192
    .local v4, profile:Lcom/android/settings/vpn2/VpnProfile;
    ...
    .line 198
    invoke-virtual {v3, v4}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->update(Lcom/android/settings/vpn2/VpnProfile;)V
    ...
    const-string v5, "/dev/iwland/iwlandrunning"
    ...
    .end local v4           #profile:Lcom/android/settings/vpn2/VpnProfile;
    :cond_0
    :goto_1
    return-void
    ...
    .restart local v4       #profile:Lcom/android/settings/vpn2/VpnProfile;
    :cond_1
    ...
    invoke-direct {v3, p0, v5, v4}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;-><init>(Lcom/android/settings/vpn2/VpnSettings;Landroid/content/Context;Lcom/android/settings/vpn2/VpnProfile;)V
    ...
    :cond_2
    :try_start_0
    invoke-direct {p0, v4}, Lcom/android/settings/vpn2/VpnSettings;->connect(Lcom/android/settings/vpn2/VpnProfile;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-virtual {v2}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->getProfile()Lcom/android/settings/vpn2/VpnProfile;
    ...
    invoke-virtual {v2}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->getState()I
    ...
    invoke-virtual {v0}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->getState()I
