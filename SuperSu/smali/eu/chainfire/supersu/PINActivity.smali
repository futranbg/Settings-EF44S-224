...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Leu/chainfire/supersu/PINActivity;->u:J

    iput-boolean v2, p0, Leu/chainfire/supersu/PINActivity;->v:Z

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Leu/chainfire/supersu/PINActivity;->w:Landroid/os/Bundle;

    return-void
.end method

.method static synthetic a(Leu/chainfire/supersu/PINActivity;)I
    .locals 1
...
.method public static a(Landroid/app/Activity;ILandroid/content/Intent;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    .locals 3
    ...
    invoke-static {p0, p2}, Leu/chainfire/supersu/PINActivity;->a(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-direct {v2, p4}, Leu/chainfire/supersu/PINActivity$1;-><init>(Ljava/lang/Runnable;)V
    ...
    invoke-direct {v1, p4}, Leu/chainfire/supersu/PINActivity$2;-><init>(Ljava/lang/Runnable;)V
...
.method public static a(Landroid/app/Activity;ILjava/lang/String;ZJ)V
    .locals 4
...
.method private a(ILjava/lang/String;)Z
    ...
    iget-boolean v2, p0, Leu/chainfire/supersu/PINActivity;->p:Z
    ...
    const-string v3, "eu.chainfire.supersu.pin"

    invoke-direct {v2, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v3, "eu.chainfire.supersu.pin.status"

    invoke-virtual {v2, v3, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    if-ne p1, v1, :cond_1

    const-string v3, "eu.chainfire.supersu.pin.code"

    invoke-virtual {v2, v3, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    :cond_1
    iget-boolean v3, p0, Leu/chainfire/supersu/PINActivity;->q:Z

    if-eqz v3, :cond_2

    const/4 v0, -0x1

    invoke-virtual {p0, v0, v2}, Leu/chainfire/supersu/PINActivity;->setResult(ILandroid/content/Intent;)V
    ...
    iget-object v4, p0, Leu/chainfire/supersu/PINActivity;->r:Ljava/lang/String;

    invoke-virtual {v3, v4}, Leu/chainfire/supersu/Settings;->c(Ljava/lang/String;)Leu/chainfire/supersu/Settings$App;

    move-result-object v4

    iget-object v5, v4, Leu/chainfire/supersu/Settings$App;->h:Ljava/lang/String;

    if-eqz v5, :cond_3

    iget-object v5, v4, Leu/chainfire/supersu/Settings$App;->h:Ljava/lang/String;

    invoke-static {p0, v2, v5}, Leu/chainfire/supersu/PINActivity;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Leu/chainfire/supersu/PINActivity;->getString(I)Ljava/lang/String;

    move-result-object v1

    new-instance v2, Leu/chainfire/supersu/PINActivity$3;

    invoke-direct {v2, p0, v4, v3}, Leu/chainfire/supersu/PINActivity$3;-><init>(Leu/chainfire/supersu/PINActivity;Leu/chainfire/supersu/Settings$App;Leu/chainfire/supersu/Settings;)V

    new-instance v5, Leu/chainfire/supersu/PINActivity$4;

    invoke-direct {v5, p0, v4, v3}, Leu/chainfire/supersu/PINActivity$4;-><init>(Leu/chainfire/supersu/PINActivity;Leu/chainfire/supersu/Settings$App;Leu/chainfire/supersu/Settings;)V

    invoke-static {p0, v1, v2, v5}, Leu/chainfire/supersu/Constants;->a(Landroid/content/Context;Ljava/lang/String;Leu/chainfire/supersu/Constants$OnExpireTimeSelected;Ljava/lang/Runnable;)V

    :goto_1
    iget v1, p0, Leu/chainfire/supersu/PINActivity;->s:I

    invoke-static {v1}, Leu/chainfire/supersu/PromptQueue;->a(I)V
    ...
    invoke-static {p0, v2}, Leu/chainfire/supersu/PINActivity;->a(Landroid/content/Context;Landroid/content/Intent;)Z

    move-result v2

    if-eqz v2, :cond_6

    iget-wide v5, p0, Leu/chainfire/supersu/PINActivity;->u:J

    iput-wide v5, v4, Leu/chainfire/supersu/Settings$App;->c:J
    ...
    :cond_4
    iput v1, v4, Leu/chainfire/supersu/Settings$App;->n:I

    :goto_2
    invoke-virtual {v4}, Leu/chainfire/supersu/Settings$App;->e()V

    invoke-virtual {v3, p0}, Leu/chainfire/supersu/Settings;->b(Landroid/content/Context;)V

    iget v0, p0, Leu/chainfire/supersu/PINActivity;->s:I

    invoke-virtual {v4, p0, v0, v1}, Leu/chainfire/supersu/Settings$App;->a(Landroid/content/Context;II)V
    ...
    :cond_5
    iput v7, v4, Leu/chainfire/supersu/Settings$App;->n:I

    goto :goto_2

    :cond_6
    iput-wide v8, v4, Leu/chainfire/supersu/Settings$App;->c:J
    ...
    iget v2, p0, Leu/chainfire/supersu/PINActivity;->s:I

    invoke-virtual {v4, p0, v2, v0}, Leu/chainfire/supersu/Settings$App;->a(Landroid/content/Context;II)V
...
.method public static a(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {p0, p1, v0}, Leu/chainfire/supersu/PINActivity;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Z
...
.method public static a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Leu/chainfire/supersu/Settings;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method public onBackPressed()V
    ...
    invoke-direct {p0, v0, v1}, Leu/chainfire/supersu/PINActivity;->a(ILjava/lang/String;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Leu/chainfire/supersu/PINActivity;->w:Landroid/os/Bundle;
    ...
    iget-boolean v0, p0, Leu/chainfire/supersu/PINActivity;->v:Z
    ...
    :cond_3
    new-instance v0, Leu/chainfire/supersu/PINActivity$5;

    invoke-direct {v0, p0}, Leu/chainfire/supersu/PINActivity$5;-><init>(Leu/chainfire/supersu/PINActivity;)V
    ...
    invoke-direct {p0, v0, v3}, Leu/chainfire/supersu/PINActivity;->a(ILjava/lang/String;)Z
    ...
    iput-boolean v0, p0, Leu/chainfire/supersu/PINActivity;->v:Z
...
.method public onPIN(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0, v2}, Leu/chainfire/supersu/PINActivity;->a(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v0}, Leu/chainfire/supersu/PINActivity;->a(ILjava/lang/String;)Z
