...
.field private final f:Landroid/support/v4/widget/aa;

.field private final g:Landroid/support/v4/widget/aa;

.field private final h:Landroid/support/v4/widget/e;

.field private final i:Landroid/support/v4/widget/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/e;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/e;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/e;

    .line 234
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/e;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/aa;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ad;)Landroid/support/v4/widget/aa;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    .line 235
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    invoke-virtual {v1, v3}, Landroid/support/v4/widget/aa;->a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/e;->a(Landroid/support/v4/widget/aa;)V

    .line 239
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/e;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/aa;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ad;)Landroid/support/v4/widget/aa;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    .line 240
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/aa;->a(I)V
    ...
    .line 242
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/e;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/e;->a(Landroid/support/v4/widget/aa;)V
...
.method private e()Z
    ...
    .line 1154
    iget-boolean v0, v0, Landroid/support/v4/widget/c;->c:Z
...
.method a()Landroid/view/View;
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/c;->d:Z
...
.method public a(II)V
    ...
    .line 346
    invoke-static {p0}, Landroid/support/v4/view/au;->e(Landroid/view/View;)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    .line 356
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/aa;->e()V
    ...
    .line 355
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/aa;->a()I

    move-result v2

    .line 443
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    invoke-virtual {v3}, Landroid/support/v4/widget/aa;->a()I
    ...
    .line 456
    iget v2, v0, Landroid/support/v4/widget/c;->b:F
    ...
    .line 458
    :cond_6
    iget v0, v0, Landroid/support/v4/widget/c;->b:F
...
.method a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/c;->c:Z
    ...
    .line 981
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/aa;->a(Landroid/view/View;II)Z
    ...
    .line 988
    :goto_2
    iput-boolean v3, v0, Landroid/support/v4/widget/c;->c:Z

    goto :goto_1

    .line 984
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/aa;->a(Landroid/view/View;II)Z
    ...
    .line 991
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/e;

    invoke-virtual {v0}, Landroid/support/v4/widget/e;->a()V
...
.method b(Landroid/view/View;)V
    ...
    .line 474
    iget-boolean v1, v0, Landroid/support/v4/widget/c;->d:Z
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/c;->d:Z
...
.method b(Landroid/view/View;F)V
    ...
    .line 502
    iget v1, v0, Landroid/support/v4/widget/c;->b:F
    ...
    .line 506
    :cond_0
    iput p2, v0, Landroid/support/v4/widget/c;->b:F
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/aa;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/aa;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/aa;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/aa;->b()I
...
.method e(Landroid/view/View;)I
    ...
    iget v0, v0, Landroid/support/v4/widget/c;->a:I

    .line 516
    invoke-static {p1}, Landroid/support/v4/view/au;->e(Landroid/view/View;)I
...
.method public h(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/c;->b:F
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/aa;->a(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 855
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/aa;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/aa;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/aa;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/aa;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/aa;->d(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 678
    iget v1, v0, Landroid/support/v4/widget/c;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/c;->topMargin:I

    iget v3, v0, Landroid/support/v4/widget/c;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/c;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v4/widget/c;->b:F
    ...
    .line 697
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/c;->a:I
    ...
    .line 702
    iget v4, v0, Landroid/support/v4/widget/c;->topMargin:I
    ...
    .line 708
    iget v10, v0, Landroid/support/v4/widget/c;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/c;->bottomMargin:I
    ...
    .line 721
    iget v12, v0, Landroid/support/v4/widget/c;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/c;->bottomMargin:I
    ...
    .line 724
    iget v4, v0, Landroid/support/v4/widget/c;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 635
    iget v7, v0, Landroid/support/v4/widget/c;->leftMargin:I

    sub-int v7, v2, v7

    iget v8, v0, Landroid/support/v4/widget/c;->rightMargin:I
    ...
    .line 637
    iget v8, v0, Landroid/support/v4/widget/c;->topMargin:I

    sub-int v8, v1, v8

    iget v0, v0, Landroid/support/v4/widget/c;->bottomMargin:I
    ...
    iget v8, v0, Landroid/support/v4/widget/c;->leftMargin:I
    ...
    iget v8, v0, Landroid/support/v4/widget/c;->width:I
    ...
    iget v9, v0, Landroid/support/v4/widget/c;->bottomMargin:I

    add-int/2addr v8, v9

    iget v0, v0, Landroid/support/v4/widget/c;->height:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1266
    iget-boolean v4, v0, Landroid/support/v4/widget/c;->d:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/aa;->b(Landroid/view/MotionEvent;)V
    ...
    .line 918
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/aa;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/aa;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/aa;->d()I
