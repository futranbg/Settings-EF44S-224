...
.method a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/p;->o:Landroid/support/v4/app/h;
    ...
    .line 1783
    iget-object v3, p0, Landroid/support/v4/app/p;->o:Landroid/support/v4/app/h;

    iget-object v4, p0, Landroid/support/v4/app/p;->q:Landroid/support/v4/app/Fragment;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/FragmentState;->a(Landroid/support/v4/app/h;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/p;->a(ILandroid/support/v4/app/b;)V
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/h;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/h;->a(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/ad;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->e()Landroid/content/res/Resources;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ad;->a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 1069
    :cond_2e
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/h;
...
.method public a(Landroid/support/v4/app/h;Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;)V
    .locals 2
    .parameter
    .parameter
    .parameter
    ...
    .line 1861
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/p;->o:Landroid/support/v4/app/h;
...
.method public a(Ljava/lang/Runnable;Z)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/h;->a:Landroid/os/Handler;
...
.method public b(Landroid/support/v4/app/Fragment;II)V
    ...
    .line 1211
    invoke-virtual {p0, p1, p2, v3, p3}, Landroid/support/v4/app/p;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method d(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/h;->a(Ljava/lang/String;)V
...
.method public e()Z
    ...
    iget-object v3, v3, Landroid/support/v4/app/h;->a:Landroid/os/Handler;
...
.method h()Landroid/os/Parcelable;
    ...
    invoke-direct {v4, p0, v0}, Landroid/support/v4/app/BackStackState;-><init>(Landroid/support/v4/app/p;Landroid/support/v4/app/b;)V
...
.method public r()V
    ...
    .line 1915
    iput-object v1, p0, Landroid/support/v4/app/p;->o:Landroid/support/v4/app/h;
